...
const CATEGORIES = [
  {
    value: "TANKTOP",
    label: "Tanktop",
    description: "Clean cuts, breathable fabric.",
  },
  {
    value: "OVERSIZE",
    label: "Oversize Tee",
    description: "Dropped shoulders, relaxed fit.",
  },
  // Nanti kalau udah ada, baru di uncomment
      ...
      <div className="content-wrapper">
        ...
        <div
          className={`grid gap-6 ${
            CATEGORIES.length === 2
              ? "grid-cols-2 md:grid-cols-2 md:max-w-[calc(50%-0.75rem)] mx-auto"
