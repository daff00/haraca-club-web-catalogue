        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-[var(--color-bg)] border border-[var(--color-border)] rounded-[var(--radius-card)] shadow-sm overflow-hidden">
            <div className="border-b border-[var(--color-border)] bg-[var(--color-surface)] px-5 py-3 flex justify-between items-center">
              ...
              <span className="text-xs text-[var(--color-text-muted)]">{photos.length}/{MAX_PHOTOS}</span>
            </div>
            <div className="p-5 space-y-4">
          ...
          <div className="bg-[var(--color-bg)] border border-[var(--color-border)] rounded-[var(--radius-card)] shadow-sm overflow-hidden">
            <div className="border-b border-[var(--color-border)] bg-[var(--color-surface)] px-5 py-3">
              <h2 className="text-sm font-semibold text-[var(--color-text)] flex items-center gap-2">
                ...
                Purchase Links
                <span className="text-xs font-normal text-[var(--color-text-muted)] ml-1">(optional)</span>
              </h2>
            </div>
            <div className="p-5 space-y-4">
              <div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[var(--color-bg)] border border-[var(--color-border)] rounded-[var(--radius-card)] shadow-sm overflow-hidden">
            ...
            <div className="p-5 flex items-center justify-between">
              <span className="text-sm text-[var(--color-text)]">{isActive ? "Active" : "Inactive"}</span>
              <button
                type="button"
          ...
          <div className="bg-[var(--color-bg)] border border-[var(--color-border)] rounded-[var(--radius-card)] shadow-sm overflow-hidden">
            <div className="border-b border-[var(--color-border)] bg-[var(--color-surface)] px-5 py-3">
              <h2 className="text-sm font-semibold text-[var(--color-text)]">Labels</h2>
            </div>
          ...
          <div className="bg-[var(--color-bg)] border border-[var(--color-border)] rounded-[var(--radius-card)] shadow-sm overflow-hidden">
            ...
            <div className="p-5">
              ...
              {errors.sizes && <p className="text-xs text-red-500 mt-2">{errors.sizes}</p>}
              {sizes.length === 0 && !errors.sizes && (
                <p className="text-xs text-[var(--color-text-muted)] mt-2">Select at least one size.</p>
              )}
            </div>
          </div>
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="space-y-2 pt-2 border-t border-[var(--color-border)]">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  />
                  <span className="text-xs text-[var(--color-text-muted)] font-mono">{colorHex}</span>
                  <button
                    type="button"
                    onClick={addColor}
                    className="flex-1 border border-[var(--color-border)] text-[var(--color-text)] py-1.5 rounded-[var(--radius-btn)] text-xs font-medium hover:bg-[var(--color-surface)] transition-colors flex items-center justify-center gap-1"
                  >
